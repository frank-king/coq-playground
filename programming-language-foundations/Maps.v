...
Proof.
  intros x y.
  destruct (eqb_string x y) eqn:H.
  - apply ReflectT. apply eqb_string_true_iff. apply H.
  - apply ReflectF. apply eqb_string_false_iff. apply H.
Qed.
(** [] *)
...
Proof.
  ...
  - destruct (eqb_stringP x2 x).
    + exfalso. apply H. rewrite e0. rewrite e. reflexivity.
    + reflexivity.
  - destruct (eqb_stringP x2 x).
    + reflexivity.
    + reflexivity.
